...
const SPECIAL_SURAH_QUESTIONS: Record<number, { q: string; options: string[]; correctAnswerIndex: number; explanation: string; }[]> = {
  ...
  18: [ // Al-Kahf
    ...
    },
    {
      ...
      correctAnswerIndex: 0,
      explanation: "আসহাবে কাহফ (গুহার অধিবাসী) একদল ঈমানদার সৎ যুবকের কাহিনী, যারা মূর্তিপূজারী রাজার হাত থেকে ঈমান বাঁচাতে গুহায় আশ্রয় নিয়েছিলেন।"
    },
    {
      q: "হযরত মূসা (আঃ) এর সঙ্গে কোন বিশেষ জ্ঞানসম্পন্ন আলৌকিক চরিত্রের মানুষের সফর কাহিনী সূরা কাহফে এসেছে?",
      options: ["হযরত খিযির (আঃ)", "হযরত শুয়াইব (আঃ)", "হযরত লোকমান (আঃ)", "হযরত ইউসুফ (আঃ)"],
      correctAnswerIndex: 0,
  ...
  36: [ // Ya-Sin
    {
      q: "পবিত্র কুরআনের হৃদপিণ্ড বা 'অন্তর' (Heart of Quran) বলা হয় কোন সূরাকে?",
  ...
  112: [ // Al-Ikhlas
    {
      ...
      correctAnswerIndex: 1,
      explanation: "হাদীস অনুসারে সূরা আল-ইখলাসে আল্লাহর সুউচ্চ সুনিপুণ একত্ববাদ (তাওহীদ) ঘোষিত হওয়ায় একে ৩ ভাগের ১ ভাগ কুরআনের সমতুল্const QUIZ_QUESTIONS: QuizQuestion[] = [
  {
    id: 1,
    category: "surah",
